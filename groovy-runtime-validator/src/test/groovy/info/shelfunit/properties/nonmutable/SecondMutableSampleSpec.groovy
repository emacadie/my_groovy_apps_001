...
class SecondMutableSampleSpec extends Specification { 
    ...
    def "test the no arg constructor"() {
        ...
        def throwaway = new SecondMutableSample( firstString: "Not Junk", secondString: "Goodbye Junk", firstInt: 21, secondInt: 30 )
        // throwaway.firstString = "Throwaway"
        println "Just made throwaway, about to make bTest1"
        def bTest1 = new SecondMutableSample( firstString: "Hello1", secondString: "Goodbye", firstInt: 21, secondInt: 2000 )
    ...
    def "test bTest2"() {
        println "--- Starting test ${name.methodName}"
        def bTest2 = new SecondMutableSample( firstString: "Hello2", secondString: "Goodbye, this is more than 20 characters", firstInt: 22, secondInt: 20 )
    ...
    def "test the no arg constructor again"() {
        ...
        */
        ...
        def bTest1 = new SecondMutableSample( firstString: "Hello3", secondString: "Goodbye", firstInt: 21, secondInt: 200 )
        println "In test ${name.methodName}, bTest1: ${bTest1.toString()}"
        expect:
