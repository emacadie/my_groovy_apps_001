		...
		<div id="list-shiroRole" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreated" title="${message(code: 'shiroRole.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="lastUpdated" title="${message(code: 'shiroRole.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${shiroRoleInstanceList}" status="i" var="shiroRoleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${shiroRoleInstance.dateCreated}" /></td>
					
						<td><g:formatDate date="${shiroRoleInstance.lastUpdated}" /></td>
