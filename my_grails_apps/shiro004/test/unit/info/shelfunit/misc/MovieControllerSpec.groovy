...
class MovieControllerSpec extends Specification {
    ...
    def populateValidParams( params ) {
        ...
        params[ "title" ] = "Hello"
        params[ "year" ] = 2014
        params[ "summary" ] = "a movie that is pleased to meet you"
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        then:"A redirect is issued to the show action"
            response.redirectedUrl == null //  '/movie/show/1'
            println "Here is controller.flash.message: ${controller.flash.message}"
            controller.flash.message == null // != null
            Movie.count() == 0 // 1
    }
