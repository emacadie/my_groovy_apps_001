...
class PersonController {
    ...
    def handleLogin() {
        ...
        if (!person) {
            flash.message = "Person not found for personName: ${params.personName}"
    ...
    def save() {
        ...
        flash.message = message(code: 'person.saved.message', args: [personInstance.firstName, personInstance.lastName])
        // flash.message = "person.saved.message"
        // flash.args = [person.firstName, person.lastName]
        // flash.defaultMsg = "Person Saved"
        ...
        if (version != null) {
            if (personInstance.version > version) {
                personInstance.errors.rejectValue("version", "default.optimistic.locking.failure",
                          ...
                          "Another person has updated this Person while you were editing")
