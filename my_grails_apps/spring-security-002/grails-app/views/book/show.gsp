			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="owner-label" class="property-label"><g:message code="book.owner.label" default="Owner" /></span>
						...
						<span class="property-value" aria-labelledby="owner-label"><g:link controller="secUser" action="show" id="${bookInstance?.owner?.id}">${bookInstance?.owner?.encodeAsHTML()}</g:link></span>
