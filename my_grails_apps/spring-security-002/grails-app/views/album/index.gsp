		...
		<div id="list-album" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="artist" title="${message(code: 'album.artist.label', default: 'Artist')}" />
						...
						<th><g:message code="album.owner.label" default="Owner" /></th>
				...
				<g:each in="${albumInstanceList}" status="i" var="albumInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: albumInstance, field: "numberOfTracks")}</td>
					
						<td>${fieldValue(bean: albumInstance, field: "owner")}</td>
