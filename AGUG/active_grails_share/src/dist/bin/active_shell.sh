...
CLASSPATH=$APP_HOME/lib/active_grails_share.jar:$APP_HOME/lib/slf4j-api-1.7.7.jar
CLASSPATH=$CLASSPATH:$APP_HOME/lib/activejdbc-1.4.1.jar:$APP_HOME/lib/postgresql-9.3-1101-jdbc41.jar
CLASSPATH=$CLASSPATH:$APP_HOME/lib/javalite-common-1.4.1.jar:$APP_HOME/lib/junit-4.8.2.jar
